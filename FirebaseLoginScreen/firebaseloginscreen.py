...
class FirebaseLoginScreen(Screen, EventDispatcher):
    ...
    localId = " " #App.get_running_app().localId
    idToken = " " #App.get_running_app().idToken
    ...
    email_exists = BooleanProperty(True)
    ...
    def on_web_api_key(self, *args):
        ...
        try:
            ...
            self.refresh_token_file = App.get_running_app().refresh_token_file
            if self.debug:
    ...
    def save_refresh_token(self, refresh_token):
        ...
        self.refresh_token_file = app.refresh_token_file
        if self.debug:
    ...
    def load_refresh_token(self):
        ...
        try:
            ...
            print("User not Signed In-File not found")
